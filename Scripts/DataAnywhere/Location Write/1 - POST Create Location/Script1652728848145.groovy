...
response = WS.sendRequest(findTestObject('DataAnywhere/Location Write/DA - Create Location', [('ReferenceCode') : GlobalVariable.AutoReferenceCode]))
