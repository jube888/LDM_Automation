...
response = WS.sendRequestAndVerify(findTestObject('LDM Core/LocationHistoryGetByLocationID'))
...
if (arrayLength < 1 ) {
	assert false;
	println('History has not been written.')
} else {
	println("History has been written.")
	assert true;
}
